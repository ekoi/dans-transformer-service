...
{
    documentBuilder_object *obj = (documentBuilder_object *)ecalloc(1, sizeof(documentBuilder_object)+ zend_object_properties_size(type));
...
PHP_METHOD(DocumentBuilder, __destruct)
{
    ...
    documentBuilder_object *obj = (documentBuilder_object *)((char *)pobj - XtOffsetOf(documentBuilder_object, std));
...
PHP_METHOD(DocumentBuilder, setSchemaValidator){
    ...
    if (documentBuilder != nullptr) {
        ...
        schemaValidator_object * vobj = (schemaValidator_object *)((char *)ooth - XtOffsetOf(schemaValidator_object, std));
        if(vobj != NULL) {
...
PHP_METHOD(DocumentBuilder, parseXmlFromString)
{
    ...
    if (documentBuilder != nullptr) {
        ...
        XdmNode* node = documentBuilder->parseXmlFromString(source);
        if(node != nullptr) {
...
zend_function_entry DocumentBuilder_methods[] = {
    PHP_ME(DocumentBuilder,  __destruct,     nullptr, ZEND_ACC_PUBLIC | ZEND_ACC_DTOR)
    PHP_ME(DocumentBuilder, setLineNumbering, nullptr, ZEND_ACC_PUBLIC)
    PHP_ME(DocumentBuilder, isLineNumbering, nullptr, ZEND_ACC_PUBLIC)
    PHP_ME(DocumentBuilder, setSchemaValidator, nullptr, ZEND_ACC_PUBLIC)
    PHP_ME(DocumentBuilder, getSchemaValidator, nullptr, ZEND_ACC_PUBLIC)
    PHP_ME(DocumentBuilder, setDTDValidation, nullptr, ZEND_ACC_PUBLIC)
    PHP_ME(DocumentBuilder, isDTDValidation, nullptr, ZEND_ACC_PUBLIC)
    PHP_ME(DocumentBuilder, setBaseUri, nullptr, ZEND_ACC_PUBLIC)
    PHP_ME(DocumentBuilder, getBaseUri, nullptr, ZEND_ACC_PUBLIC)
    PHP_ME(DocumentBuilder, parseXmlFromString, nullptr, ZEND_ACC_PUBLIC)
    PHP_ME(DocumentBuilder, parseXmlFromFile, nullptr, ZEND_ACC_PUBLIC)
    PHP_ME(DocumentBuilder, parseXmlFromUri, nullptr, ZEND_ACC_PUBLIC)
    PHP_ME(DocumentBuilder, exceptionOccurred, nullptr, ZEND_ACC_PUBLIC)
    PHP_ME(DocumentBuilder, exceptionClear, nullptr, ZEND_ACC_PUBLIC)
    PHP_ME(DocumentBuilder, getErrorMessage, nullptr, ZEND_ACC_PUBLIC)
    PHP_ME(DocumentBuilder, getErrorCode, nullptr, ZEND_ACC_PUBLIC)
